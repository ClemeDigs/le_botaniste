...
export type HoraireQueryVariables = StorefrontAPI.Exact<{[key: string]: never}>;

export type HoraireQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id'> & {
        jour?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
        debut?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
        fin?: StorefrontAPI.Maybe<Pick<StorefrontAPI.MetaobjectField, 'value'>>;
      }
    >;
  };
};
        ...
        variants: {
          nodes: Array<
            Pick<StorefrontAPI.ProductVariant, 'id'> & {
              selectedOptions: Array<
                Pick<StorefrontAPI.SelectedOption, 'value' | 'name'>
              >;
...
export type EmployeesQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;
...
export type EmployeesQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id'> & {
        firstname?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
        lastname?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
        profilepicture?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
        age?: StorefrontAPI.Maybe<Pick<StorefrontAPI.MetaobjectField, 'value'>>;
        position?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
        salary?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
...
> & {
  comments?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'key' | 'value'>
  >;
  animaux?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  arrosage?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  luminosite?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
...
interface GeneratedQueryTypes {
  '#graphql\nquery horaire {\n    metaobjects(first: 10, type: "horaire") {\n      nodes {\n        id\n        jour: field(key: "jour") {\n          value\n        }\n        debut: field(key: "debut") {\n          value\n        }\n        fin: field(key: "fin") {\n          value\n        }\n      }\n    }\n  }\n': {
    return: HoraireQuery;
    variables: HoraireQueryVariables;
  };
